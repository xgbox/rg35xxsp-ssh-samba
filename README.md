...
By default, the RG35XXSP is set to sleep within 1 minute of inactivity. SSH and Samba also stops working -- presumably from its Wi-Fi turning off during sleep -- but will automatically resume once out of sleep. This timer can be adjusted by going to Settings > Lock screen on the device.
